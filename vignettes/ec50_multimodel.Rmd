...
Use `plot_EC50_curves()` to visualize raw observations and fitted dose-response curves in the same graph. The function uses the same grouping idea as `estimate_EC50()` and `ec50_multimodel()`.
